...
export default () => {
  console.log('NewBillUI called');
/* Linked label and input by adding the right id to input, so as to stop error showing in the issues in console*/
  return (`
    <div class='layout'>
      ${VerticalLayout(120)}
      <div class='content'>
            ...
            <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required id="datepicker" type="date" class="form-control blue-border" data-testid="datepicker" />
                  </div>
                  <div class="col-half">
                    <label for="amount" class="bold-label">Montant TTC </label>
                    <input required id="amount" type="number" class="form-control blue-border input-icon input-icon-right" data-testid="amount" placeholder="348"/>
                  </div>
                  <div class="col-half-row">
                    ...
                    <div class="flex-col">
                      ...
                      <input required id="pct" type="number" class="form-control blue-border" data-testid="pct" placeholder="20" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
